...
/**
 * This is the model class for table "cruge_authitem".
 *
 * The followings are the available columns in table 'cruge_authitem':
 ...
 */
class CrugeAuthitem extends CActiveRecord
{
	/**
	 ...
	 * @return CrugeAuthitem the static model class
	 */
