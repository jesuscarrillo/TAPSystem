...
class CrugeUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('iduser, regdate, actdate, logondate, username, email, password, authkey, state, totalsessioncounter, currentsessioncounter, fecha', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'inscripcions' => array(self::HAS_MANY, 'Inscripcion', 'Estudiante_id'),
			'inscripcions1' => array(self::HAS_MANY, 'Inscripcion', 'Estudiante_id2'),
			'tesises' => array(self::HAS_MANY, 'Tesis', 'Usuario_id'),
			...
			'areas' => array(self::MANY_MANY, 'Area', 'uio_lon(Usuario_id, Area_id)'),
		);
	}
