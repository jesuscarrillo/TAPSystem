...
/**
 * This is the model class for table "cruge_authitemchild".
 *
 * The followings are the available columns in table 'cruge_authitemchild':
 ...
 */
class CrugeAuthitemchild extends CActiveRecord
{
	/**
	 ...
	 * @return CrugeAuthitemchild the static model class
	 */
