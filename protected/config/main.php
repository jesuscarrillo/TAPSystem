...
return array(
    ...
    'name' => 'Comisión T.A.P Ing. En Informática',
...
//
        ...
        'db' => array(
            'connectionString' => 'mysql:host=tapserver.local;dbname=tap3',
            'emulatePrepare' => true,
            'username' => 'tap3',
            'password' => 'Software2014',
            'charset' => 'utf8',
        ),
        'errorHandler' => array(
    ...
    'params' => array(
        ...
        'adminEmail' => 'tapinformatica@unet.edu.ve',
    ),
